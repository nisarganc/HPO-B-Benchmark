...
This repo is derived from [HPO-B Benchmark](https://github.com/releaunifreiburg/HPO-B) to evaluate a newly proposed generative HPO Model. It utilizes their meta-dataset to assess the performance of a VAE and Transformer based black-box HPO algorithm.
